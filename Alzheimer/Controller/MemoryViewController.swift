...
class MemoryViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, NSFetchedResultsControllerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, AlbumCellDelegate {
    ...
    // Properties for tracking the current cell and album name
    var currentCell: AlbumCollectionViewCell?
    var currentAlbumName: String?
    
    // NSFetchedResultsController for managing the fetched albums
    var fetchedResultsController: NSFetchedResultsController<Albums>!
    
    // Flag for indicating the edit mode
    var isEditMode = false
    
    // Managed context for Core Data operations
    let managedContext = (UIApplication.shared.delegate as! AppDelegate).persistentContainer.viewContext
    
    // Image picker controller for selecting photos
    ...
    override func viewDidLoad() {
        ...
        // Register the custom cell nib for the collection view
        ...
        // Fetch the albums from Core Data using NSFetchedResultsController
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        // Get the album for the current index path
        let album = fetchedResultsController.object(at: indexPath)
        
        // Configure the cell with album data
    ...
    @IBAction func editButtonTapped(_ sender: UIBarButtonItem) {
        ...
        if isEditMode {
            // Show options for add person, delete person, or cancel
            ...
            let addPersonAction = UIAlertAction(title: "Add Person", style: .default) { _ in
                let albumController = UIAlertController(title: "New Album", message: "Enter a name of your loved one", preferredStyle: .alert)
                ...
                let addAction = UIAlertAction(title: "Add", style: .default) { _ in
                    ...
                    // Create a new album entity and save it to Core Data
            ...
            if let selectedIndexPaths = self.collectionView.indexPathsForSelectedItems {
                for indexPath in selectedIndexPaths {
                    // Delete the selected albums from Core Data
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ShowPhotosSegue",
           ...
           let indexPath = sender as? IndexPath {
            // Pass the selected album data to the PhotoViewController
